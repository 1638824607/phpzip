...
$zip_files = array("1.php", "2.php");
$PHPZip->ZipFile($zip_files, "2.zip", 2); //多个文件批量压缩打包 第三个参数1为直接下载，2为保存到服务器
$PHPZip->Unzip_File("1.zip", "uploads"); //参数一：解压的压缩包，参数二：
$lists = get_List("1.zip"); //获取压缩包文件列表
//phpzip系统压缩类
//phpzip压缩,php压缩类,php在线压缩
//PHP压缩不好演示，因此本文直接贴下压缩类方法和zip调用方法。功能包含文件夹打包，多个文件批量打包，解压压缩包和获取压缩包文件列表。
?>